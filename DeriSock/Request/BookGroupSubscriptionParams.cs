namespace DeriSock.Request
{
  ...
  public class BookGroupSubscriptionParams : ISubscriptionChannel
  {
    ...
    /// <summary>
    /// <para>Group prices (by rounding). Use <c>none</c> for no grouping. For ETH crypto currency, real group is divided by 100.0, e.g. given value 5 means using 0.05</para>
