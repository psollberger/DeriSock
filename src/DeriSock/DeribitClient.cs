...
#region Announcements
  ...
  public Task<JsonRpcResponse<Announcement[]>> PublicGetAnnouncements(DateTime startTime)
    => Send(
      ...
      new
      {
        start_timestamp = startTime.ToUnixTimeMilliseconds()
      },
      new ObjectJsonConverter<Announcement[]>());
  ...
  public Task<JsonRpcResponse<Announcement[]>> PublicGetAnnouncements(DateTime startTime, int count)
  {
    ...
    return Send(
      ...
      new
      {
        start_timestamp = startTime.ToUnixTimeMilliseconds(), count
      },
      new ObjectJsonConverter<Announcement[]>());
  }
...
#region Block Trade
  ...
  public Task<JsonRpcResponse<BlockTrade>> PrivateExecuteBlockTrade(BlockTradeParams @params)
  {
    ...
    if (@params.Currency != default(string))
  ...
  ///   <paramref name="endId" />
  /// </param>
  public Task<JsonRpcResponse<BlockTrade[]>> PrivateGetLastBlockTradesByCurrency
  (
    string currency,
  ...
  )
  {
    ...
    if (startId != default(string))
      args.TryAdd("start_id", startId);

    if (endId != default(string))
...
#region Trading
  ...
  public Task<JsonRpcResponse<UserOrderTrades>> PrivateBuy(BuyParams @params)
  {
    ...
    if (@params.Trigger != default(string))
      args.TryAdd("trigger", @params.Trigger);

    if (@params.Advanced != default(string))
  ...
  public Task<JsonRpcResponse<UserOrder[]>> PrivateGetOrderHistoryByCurrency
  (
    string currency,
  ...
  /// <param name="includeOld">Include in result orders oder than 2 days, default - <c>false</c></param>
  /// <param name="includeUnfilled">Include in result fully unfilled closed orders, default - <c>false</c></param>
  public Task<JsonRpcResponse<UserOrder[]>> PrivateGetOrderHistoryByInstrument
  (
  ...
  public Task<JsonRpcResponse<UserStopOrderCollection>> PrivateGetStopOrderHistory
  (
    string currency,
  ...
  )
  {
    ...
    if (instrumentName != default(string))
      args.TryAdd("instrument_name", instrumentName);

    if (count > 0)
      args.TryAdd("count", count);

    if (continuation != default(string))
  ...
  /// </param>
  public Task<JsonRpcResponse<UserTradeCollection>> PrivateGetUserTradesByCurrency
  (
    string currency,
  ...
  ///   <para>Enum: <c>asc</c>, <c>desc</c>, <c>default</c></para>
  /// </param>
  public Task<JsonRpcResponse<UserTradeCollection>> PrivateGetUserTradesByCurrencyAndTime
  (
    string currency,
  ...
  )
  {
    ...
    if (startTime != default(DateTime))
      args.TryAdd("start_timestamp", startTime.ToUnixTimeMilliseconds());

    if (endTime != default(DateTime))
      args.TryAdd("end_timestamp", endTime.ToUnixTimeMilliseconds());
  ...
  ///   <para>Enum: <c>asc</c>, <c>desc</c>, <c>default</c></para>
  /// </param>
  public Task<JsonRpcResponse<UserTrade[]>> PrivateGetUserTradesByInstrument
  (
    string instrumentName,
  ...
  )
  {
    ...
    if (startSeq != default(long))
      args.TryAdd("start_seq", startSeq);

    if (endSeq != default(long))
  ...
  ///   <para>Enum: <c>asc</c>, <c>desc</c>, <c>default</c></para>
  /// </param>
  public Task<JsonRpcResponse<UserTrade[]>> PrivateGetUserTradesByInstrumentAndTime
  (
    string instrumentName,
  ...
  /// </param>
  /// <param name="count">Number of requested items, default - <c>20</c></param>
  public Task<JsonRpcResponse<SettlementCollection>> PrivateGetSettlementHistoryByInstrument
  (
    string instrumentName,
  ...
  )
  {
    ...
    return Send(
      ...
      args,
      new ObjectJsonConverter<SettlementCollection>());
  }
  ...
  /// </param>
  /// <param name="count">Number of requested items, default - <c>20</c></param>
  public Task<JsonRpcResponse<SettlementCollection>> PrivateGetSettlementHistoryByCurrency(string currency, string type = default, int count = default)
  {
    var args = new ExpandoObject();
    args.TryAdd("currency", currency);
...
#region Market data
  ...
  public Task<JsonRpcResponse<InterestRate[]>> PublicGetFundingRateHistory(string instrumentName, DateTime startTime, DateTime endTime)
    => Send(
      ...
      new
      {
        instrument_name = instrumentName, start_timestamp = startTime.ToUnixTimeMilliseconds(), end_timestamp = endTime.ToUnixTimeMilliseconds()
      },
  ...
  /// </summary>
  /// <param name="currency">The currency symbol</param>
  public Task<JsonRpcResponse<TimestampValueItem[]>> PublicGetHistoricalVolatility(string currency)
    => Send(
      ...
      new ObjectJsonConverter<TimestampValueItem[]>());
  ...
  public Task<JsonRpcResponse<MarketSettlementCollection>> PublicGetLastSettlementsByCurrency
  (
    string currency,
  ...
  )
  {
    ...
    if (searchStartTime != default(DateTime))
      eo.TryAdd("search_start_timestamp", searchStartTime.ToUnixTimeMilliseconds());
  ...
  /// <param name="continuation">Continuation token for pagination</param>
  /// <param name="searchStartTime">The latest timestamp to return result for</param>
  public Task<JsonRpcResponse<MarketSettlementCollection>> PublicGetLastSettlementsByInstrument
  (
    string instrumentName,
    string type = default, int count = default, string continuation = default, DateTime searchStartTime = default
  )
  {
    ...
    if (searchStartTime != default(DateTime))
      args.TryAdd("search_start_timestamp", searchStartTime.ToUnixTimeMilliseconds());
  ...
  ///   <para>Enum: <c>asc</c>, <c>desc</c>, <c>default</c></para>
  /// </param>
  public Task<JsonRpcResponse<MarketTradeCollection>> PublicGetLastTradesByCurrency
  (
    string currency,
    string kind = default, string startId = default, string endId = default, int count = default, bool? includeOld = null, string sorting = default
  )
  ...
  ///   <para>Enum: <c>asc</c>, <c>desc</c>, <c>default</c></para>
  /// </param>
  public Task<JsonRpcResponse<MarketTradeCollection>> PublicGetLastTradesByCurrencyAndTime
  (
  ...
  ///   <para>Enum: <c>asc</c>, <c>desc</c>, <c>default</c></para>
  /// </param>
  public Task<JsonRpcResponse<MarketTradeCollection>> PublicGetLastTradesByInstrument
  (
    string instrumentName,
    long startSeq = default, long endSeq = default, int count = default, bool? includeOld = null, string sorting = default
  )
  ...
  public Task<JsonRpcResponse<TradingViewMarketData>> PublicGetTradingViewData(string instrumentName, DateTime startTime, DateTime endTime, string resolution)
    => Send(
      ...
      new
      {
        instrument_name = instrumentName, start_timestamp = startTime.ToUnixTimeMilliseconds(), end_timestamp = endTime.ToUnixTimeMilliseconds(), resolution
      },
...
#region Wallet
  ...
  public Task<JsonRpcResponse<WithdrawalEntry>> PrivateCancelWithdrawal(string currency, long id)
    => Send(
      ...
      new ObjectJsonConverter<WithdrawalEntry>());
  ...
  /// </param>
  /// <param name="tfa">TFA code, required when TFA is enabled for current account</param>
  public Task<JsonRpcResponse<WithdrawalEntry>> PrivateWithdraw(string currency, string address, decimal amount, string priority = default, string tfa = default)
  {
    var args = new ExpandoObject();
    args.TryAdd("currency", currency);
